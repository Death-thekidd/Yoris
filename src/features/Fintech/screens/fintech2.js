        ...
        <SafeAreaView style={styles.fintech2container}>
            <ScrollView>
                <FirstView1>
                   ...
                   <Icon size={30} color="#C3AD60" name="back" style={styles.pad1}/> 
                    </TouchableOpacity>
                   <BigText1 style={styles.pad}>Procurement</BigText1>
                </FirstView1>
                <SecondView1>
                    <TextInput 
                    style={styles.input}
                    ...
                    />
                    <TouchableOpacity onPress={()=>navigation.navigate('Fintech5', {
                        paramKey: pasteLink,
                    })
