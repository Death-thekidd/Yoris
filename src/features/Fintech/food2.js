  ...
  const Vendors = [
    {
      ...
      distance: 1,
      images: [
        require("../../../assets/foodImg1.png"),
        require("../../../assets/foodImg2.png"),
        require("../../../assets/foodImg3.png"),
        require("../../../assets/foodImg4.png"),
      ],
    },
    {
      name: "Vendor2",
      ...
      images: [
        require("../../../assets/foodImg3.png"),
        require("../../../assets/foodImg4.png"),
        require("../../../assets/foodImg5.png"),
        require("../../../assets/foodImg6.png"),
      ],
    },
    {
      name: "Vendor3",
      ...
      images: [
        require("../../../assets/foodImg6.png"),
        require("../../../assets/foodImg7.png"),
        require("../../../assets/foodImg8.png"),
        require("../../../assets/foodImg9.png"),
      ],
    },
  ];
  return (
